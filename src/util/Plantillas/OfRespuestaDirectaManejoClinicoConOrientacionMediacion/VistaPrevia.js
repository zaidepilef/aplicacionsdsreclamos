...
const VistaPrevia = (props) => {
    ...
    const {  instanciaForm, firmante, meses, formPdf, region, comunas, provincia, loadingUpload, handleUploadPdf } = props
    ...
    const form = {
        ...
        math: "Informa lo que indica.",
        lugar: formPdf.cotizante.hasOwnProperty('en_lugar') ? formPdf.cotizante.en_lugar[0] : "Consultorio Santa Anita",
        de: "INTENDENTA DE PRESTADORES DE SALUD (S)  SUPERINTENDENCIA DE SALUD",
        a: "Director/Representante Legal (Prestador) calle N°, Comuna Santiago Centro, Region Metropolitana"
    }
