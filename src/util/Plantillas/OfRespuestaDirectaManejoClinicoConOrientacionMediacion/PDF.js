...
const Of_Respuesta_directa_Manejo_Clinico_con_orientacion_a_mediacon = ({
  formPdf,
  meses
}) => {
  const date = new Date();
      ...
      <Page style={styles.body}>
        <View style={styles.contentRows}>
          ...
          <View style={styles.block2}>
            ...
            <Text style={styles.subtitle}>
              ...
              {formPdf.fecha_desde && meses[formPdf.fecha_desde.split("-")[1]-1]}{" "}
        ...
        <View>
          ...
          <Text style={styles.subtitledea}>
            <Text style={{ fontWeight: "bold" }}>
              {" "}
              A : SR(a). {formPdf.reclamante && formPdf.reclamante.nombres}{" "}
              {formPdf.reclamante &&
                formPdf.reclamante.apellido_paterno}
              ,{" "}
              {formPdf.cotizante &&
          ...
          <Text style={styles.subtitlemini}>JMSV</Text>
          <Text style={styles.subtitlemini}>Distribución:</Text>
          <Text style={styles.subtitlemini}>- El indicado</Text>
