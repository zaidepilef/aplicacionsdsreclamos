...
const Formulario = (props) => {
  ...
  const {  firmante, formPdf, region, comunas, provincia, handleChange, classes, handleAdd, handleRemove } = props
    ...
    <div className="row">
      ...
      <div className="col-md-6 col-12">
        <FormControl variant="outlined" margin="normal" fullWidth value="">
          ...
          >
            {provincia.map((provincias) => (
              <MenuItem value={provincias.id}>{provincias.nombre}</MenuItem>
            ))}
          </Select>
        </FormControl>
      </div>
      ...
      <div className="col-md-6 col-12">
        <FormControl variant="outlined" margin="normal" fullWidth value="">
          ...
          <Select
            ...
            id="firmante"
            onChange={handleChange}
            defaultValue={formPdf.firmante && formPdf.firmante.id || 1}
          >
            {firmante.map((firm, i) => (
