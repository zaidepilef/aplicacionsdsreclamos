    ...
    <Document>
      <Page style={styles.body}>
        <View style={styles.contentRows}>
          ...
          <View style={styles.block2}>
            ...
            <Text style={styles.subtitle}>
              ...
              Presentación N° de ingreso {formPdf && formPdf.n_reclamo}-
              {formPdf.fecha_desde && formPdf.fecha_desde.split("-")[2]} del/de
              Sr./Sra. {formPdf.cotizante && formPdf.cotizante.nombres}{" "}
              {formPdf.cotizante && formPdf.cotizante.apellido_paterno}{" "}
              {formPdf.cotizante && formPdf.cotizante.apellido_materno}, de
              fecha {formPdf.fecha_desde && formPdf.fecha_desde.split("-")[0]} de{" "}
              {formPdf.fecha_desde &&
        ...
        <View>
          ...
          <Text style={styles.subtitledea}>
            <Text style={{ fontWeight: "bold" }}>
              A : Señores SUBCOMISIÓN DE MEDICINA PREVENTIVA E INVALIDEZ
              OCCIDENTE REGIÓN METROPOLITANA
            </Text>
          </Text>
          ...
          <Text style={styles.subtitle}>Saluda atentamente a usted,</Text>
          <Text style={styles.subtitle}>
            <Text style={{ fontWeight: "bold"}}>
              "Por orden del Intendente de Fondos y Seguros Previsionales de
              Salud"
            </Text>
          </Text>
          ...
          <Text style={styles.title}>
            ...
            <Text style={styles.firma}>Superintendencia de Salud</Text>
          </Text>
          <Text style={styles.subtitle} />
          <Text style={styles.subtitlemini}>Distribución:</Text>
          <Text style={styles.subtitlemini}>
            Señores SUBCOMISIÓN DE MEDICINA PREVENTIVA E INVALIDEZ OCCIDENTE
            REGIÓN METROPOLITANA
          </Text>
          <Text style={styles.subtitlemini}>
            Sr./Sra. {formPdf.cotizante && formPdf.cotizante.nombres} {formPdf.cotizante && formPdf.cotizante.apellido_paterno}{" "}
