        ...
        <View style={styles.contentRows}>
          ...
          <View style={styles.block2}>
            <Text style={styles.reclamo}>
              ...
              <Text>
                {formPdf.n_reclamo && formPdf.n_reclamo} -{" "}
            ...
            <Text style={styles.subtitle}>
              <Text style={{ fontWeight: "bold" }}>
                ANT.:
                <Text>
                  Solicitud de {formPdf.fecha_desde && formPdf.fecha_desde.split('-')[0]} de {formPdf.fecha_desde && meses[ formPdf.fecha_desde.split('-')[1]- 1]} de {formPdf.fecha_desde && formPdf.fecha_desde.split('-')[2]}, por la que denuncia eventual vulneración a la Ley N° 20.584.
                </Text>
              </Text>
            </Text>
            <Text style={styles.subtitle}>
            ...
            <Text style={styles.subtitle}>
              <Text style={{fontWeight: "bold"}}>SANTIAGO,  {date.getDate()} de {meses[date.getMonth()]} de {date.getFullYear()} </Text>
            </Text>
          </View>
        </View>
        <View>
          ...
          <Text style={styles.subtitledea}>
            <Text style={{ fontWeight: "bold" }}>
              {" "}
              A: SR. {formPdf.reclamante && formPdf.cotizante.nombres}{" "}
          ...
          <Text style={styles.subtitle}></Text>
          <Text style={styles.subtitlemini}>FSGL/MGBM</Text>
