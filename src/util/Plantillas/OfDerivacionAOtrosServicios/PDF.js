                ...
                <View style={styles.block1}>
                    ...
                    <View style={styles.block2}>
                        <Text style={styles.reclamo}>
                            <Text style={{fontWeight: "bold"}}>SOLICITUD N°: {form.reclamo} - {form.solicitud.fecha_creacion.año} </Text>
                        </Text>
                        <Text style={styles.reclamo}>
                        ...
                        <Text style={styles.subtitle}>
                            ...
                            Presentación de fecha {form.solicitud.fecha_creacion.dia} de {form.solicitud.fecha_creacion.mes} de {form.solicitud.fecha_creacion.año}, del Sr(a). {form.nombre} {form.apellido_paterno} {form.apellido_materno},
                            RUT {form.rut}
                        </Text>
                        <Text style={styles.subtitle}>
