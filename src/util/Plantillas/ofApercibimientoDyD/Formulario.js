        ...
        <FormControl variant="outlined" margin="normal" fullWidth>
          ...
          <FormGroup>
            ...
            <FormControlLabel
              ...
              label="Copia del reclamo presentado ante el prestador de salud."
            />
            <FormControlLabel
              control={
                <Checkbox
              ...
              label="Copia de la respuesta otorgada a su reclamo, junto al sobre o correo electrónico mediante el cual la hubiere recibido."
            />
            <FormControlLabel
              ...
              label="Poder simple otorgado ante notario público, en virtud del cual el titular de los derechos eventualmente vulnerados le autoriza para actuar en su representación.  Asimismo, deberá ratificar el reclamo presentado por Ud. y autorizarle expresamente para acceder a los datos sensibles contenidos en la ficha clínica."
            />
            <FormControlLabel
              control={
                <Checkbox
                  id="documentos"
                  onChange={handleChange}
                  checked={formPdf.documentos.hec}
                  name="hec"
                  icon={<DescriptionOutlinedIcon />}
                  checkedIcon={<DescriptionIcon />}
                  color="primary"
              ...
              label="Señale con claridad los hechos y peticiones concretas."
            />
          </FormGroup>
        </FormControl>
      </div>
