    ...
    <Document>
      <Page style={styles.body}>
          ...
          <View style={styles.block2}>
            <Text style={styles.reclamo}>
              <Text style={{ fontWeight: "bold" }}>
                RECLAMO N°: {formPdf && formPdf.n_reclamo} - {formPdf && formPdf.fecha_desde.split('-')[2]}{" "}
              </Text>
            </Text>
            <Text style={styles.reclamo}>
              <Text style={{ fontWeight: "bold" }}>
        ...
        <View>
          ...
          <Text style={styles.firma}>{formPdf.firmante && formPdf.firmante.nombre}</Text>
          ...
          <Text style={styles.author3}>
            <Text style={{ fontWeight: "bold" }}>FGL/JSV</Text>
          </Text>
        </View>
        <Text
