            ...
            <Page style={styles.body}>
                <View  style={styles.contentRows}>
                    ...
                    <View style={styles.block2}>
                        <Text style={styles.reclamo}>
                            <Text style={{fontWeight: "bold"}}>RECLAMO N°: {/* {form.reclamo} - {form.fecha.año} */} Fecha </Text>
                        </Text>
                        <Text style={styles.reclamo}>
                ...
                <View>
                    <Text style={styles.subtitle}>
                        ...
                        <Text style={styles.subtitle}>
                        Lo dispuesto en los artículos 121 N°11, 141 incisos penúltimo y último, 141 bis, 173 incisos 7° y 8°, y 173 bis del DFL N°1, de 2005, de Salud; en la Ley N°19.880, que establece bases de los procedimientos administrativos que rigen los actos de los Órganos de la Administración del Estado; en la Resolución N° 7, de 2019, de la Contraloría General de la República; y en la Resolución Exenta RA/N° 882/107/2019 de la Superintendencia de Salud;
                        </Text>
                    <Text style={styles.subtitle}>
                    ...
                    <Text style={styles.text}>Que, mediante la presentación N° {/* {form.reclamo} */} Reclamo, de {/* {form.fecha.dia} de {form.fecha.mes} del {form.fecha.año} */} Fecha, el/la Sr./Sra. {/* {form.nombre} */} Reclamante, interpuso un reclamo en contra de {/* {form.prestador.nombre} */} Prestador, por eventuales incumplimientos a la Ley N° 20.394, que prohíbe condicionar la atención de salud al otorgamiento de cheques o dinero en efectivo.</Text>
                    </Text>
                    <Text style={styles.subtitle}>
                    <Text style={styles.subtitle}> <Text style={{fontWeight: "bold"}}>2.-</Text></Text>
                    <Text style={styles.text}>Que, con posterioridad, a través de la presentación N° {/* {form.reclamo} */} n Reclamo, de {/* {form.fecha.dia} de {form.fecha.mes} del {form.fecha.año} */} Fecha, el/la reclamante manifestó a este Organismo su voluntad de desistir del reclamo antedicho, manifestando que acordó una solución con el prestador reclamado.</Text>
                    </Text>
                    <Text style={styles.subtitle}>
                    ...
                    <Text style={styles.subtitle}>
                    <Text>DECLARAR DESISTIDO el reclamo presentado por el/la Sr./Sra. {/* {form.nombre} */} Reclamante en contra de {/* {form.prestador.nombre} */} Prestador.</Text>
                    </Text>
                    <Text style={styles.subtitle}>
                    ...
                    <Text style={styles.author2}><Text style={{fontWeight: "bold"}}>XXX/XXX//nombrefirmante/cargo</Text></Text>
