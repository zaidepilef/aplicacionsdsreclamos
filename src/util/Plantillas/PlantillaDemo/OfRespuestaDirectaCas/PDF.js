            ...
            <Page style={styles.body}>
                ...
                <View style={styles.block1}>
                    ...
                    <View style={styles.block2}>
                        <Text style={styles.reclamo}>
                            <Text style={{fontWeight: "bold"}}>RECLAMO N°{/*  {form.reclamo} - {form.solicitud.fecha_creacion.año} */} reclamo, fecha </Text>
                        </Text>
                        <Text style={styles.reclamo}>
                        ...
                        <Text style={styles.subtitle}>
                            ...
                            Solicitud de fecha {/* {form.solicitud.fecha_creacion.dia} de {form.solicitud.fecha_creacion.mes} de {form.solicitud.fecha_creacion.año} */} Fecha
                        </Text>
                        <Text style={styles.subtitle}>
                ...
                <View>
                    ...
                    <Text style={styles.subtitledea}>
                        ...
                        SR(a). <Text style={{color: 'red'}}> {/* {form.nombre} {form.apellido_paterno} {form.apellido_materno}, direccion: {form.direccion.calle} #{form.direccion.num} - comuna {form.direccion.comuna}, porvincia {form.direccion.provincia}  */}Nombre completo, direccion </Text>
                            Region: {/* {form.direccion.region} */} Region
                        </Text>
                    </Text>
                    <Text style={styles.subtitle}>
