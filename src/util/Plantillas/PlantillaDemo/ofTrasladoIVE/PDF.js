    ...
    <Document>
            <Page style={styles.body}>
                ...
                <View style={styles.block1}>
                    ...
                    <View style={styles.block2}>
                        ...
                        <Text style={styles.subtitle}>
                            ...
                            Reclamo {/* {form.desde.dia}-{form.desde.mes}-{form.desde.año} */} Fecha de la Sra.{/*  {form.nombre_reclamo_de_fecha} */} Nombre Reclamante, RUT {/* {form.rut_reclamo_de_fecha} */} , por eventual incumplimiento de lo previsto en el artículo 119 del Código Sanitario y la Ley N° 20.584.
                        </Text>
                        <Text style={styles.subtitle}>
                ...
                <View>
                    ...
                    {form.region.id}, {form.comuna.id} ,{form.provincia.id} */} Direccion Prestador
                    </Text>
                    </Text>
                    <Text style={styles.subtitle}>
                    ...
                    {/* {form.fecha_inicio_reclamo.dia} {form.fecha_inicio_reclamo.mes} {form.fecha_inicio_reclamo.año} */}Fecha
                    </Text>
                    <Text style={styles.subtitlemini}>
                    Distribución:
                    </Text>
