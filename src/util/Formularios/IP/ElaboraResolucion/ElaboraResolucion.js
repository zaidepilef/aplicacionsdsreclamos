...
import SimpleAlerts from "util/SimpleAlerts";
import ModalPlantilla from "util/Plantillas/ModalPlantilla/ModalPlantilla"
  ...
  return (
    <>
      <CardBox styleName="col-lg-12">
        <SelectTemplate
          observacion={instanciaForm.observacion}
      ...
      {instanciaForm.observacion && (
        <CardBox styleName="col-lg-12">
          <SimpleAlerts title={instanciaForm.observacion} />
        </CardBox>
      )}
...
export default ElaborarResolucion;
