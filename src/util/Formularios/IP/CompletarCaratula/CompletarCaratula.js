...
import { completarCaratulaSchema } from "../taskValidations";
...
const CompletarCaratula = props => {
  ...
  const {
    ...
    mode: "onBlur",
    resolver: yupResolver(completarCaratulaSchema)
  });
...
export default CompletarCaratula;
