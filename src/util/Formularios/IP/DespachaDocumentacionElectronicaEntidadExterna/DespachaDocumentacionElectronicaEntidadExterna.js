...
const DespachaDocumentacionElectronicaEntidadExterna = ({
  instanciaForm,
  handleSubmitForm
}) => {
...
DespachaDocumentacionElectronicaEntidadExterna.propTypes = {
  instanciaForm: PropTypes.object.isRequired,
  handleSubmitForm: PropTypes.func.isRequired
};

export default DespachaDocumentacionElectronicaEntidadExterna;
