...
const DespachaDocumentacionElectronicaAOtraEntidad = ({
  instanciaForm,
  handleSubmitForm
}) => {
...
DespachaDocumentacionElectronicaAOtraEntidad.propTypes = {
  instanciaForm: PropTypes.object.isRequired,
  handleSubmitForm: PropTypes.func.isRequired
};

export default DespachaDocumentacionElectronicaAOtraEntidad;
