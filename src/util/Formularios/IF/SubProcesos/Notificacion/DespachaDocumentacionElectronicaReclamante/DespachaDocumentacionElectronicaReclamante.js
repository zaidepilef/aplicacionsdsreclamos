...
const DespachaDocumentacionElectronicaReclamante = ({
  instanciaForm,
  handleSubmitForm
}) => {
...
DespachaDocumentacionElectronicaReclamante.propTypes = {
  instanciaForm: PropTypes.object.isRequired,
  handleSubmitForm: PropTypes.func.isRequired
};

export default DespachaDocumentacionElectronicaReclamante;
