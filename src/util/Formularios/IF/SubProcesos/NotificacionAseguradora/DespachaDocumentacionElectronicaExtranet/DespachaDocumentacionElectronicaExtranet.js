...
const DespachaDocumentacionElectronicaExtranet = ({
  instanciaForm,
  handleSubmitForm
}) => {
...
DespachaDocumentacionElectronicaExtranet.propTypes = {
  instanciaForm: PropTypes.object.isRequired,
  handleSubmitForm: PropTypes.func.isRequired
};

export default DespachaDocumentacionElectronicaExtranet;
