...
const NotificacionReclamanteRespectoDerivacionAseguradora = ({
  instanciaForm,
  handleSubmitForm
}) => {
...
NotificacionReclamanteRespectoDerivacionAseguradora.propTypes = {
  instanciaForm: PropTypes.object.isRequired,
  handleSubmitForm: PropTypes.func.isRequired
};

export default NotificacionReclamanteRespectoDerivacionAseguradora;
